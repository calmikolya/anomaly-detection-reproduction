...
def test(obj_names, mvtec_path, checkpoint_path, base_model_name):
    ...
    for obj_name in obj_names:
        ...
        display_images = torch.zeros((16 ,3 ,256 ,256)).to(DEVICE)
        display_gt_images = torch.zeros((16 ,3 ,256 ,256)).to(DEVICE)
        display_out_masks = torch.zeros((16 ,1 ,256 ,256)).to(DEVICE)
        display_in_masks = torch.zeros((16 ,1 ,256 ,256)).to(DEVICE)
        cnt_display = 0
